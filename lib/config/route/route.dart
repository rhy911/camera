import 'package:camera_app/features/auth/presentation/pages/verification.dart';
import 'package:camera_app/features/camera/presentation/pages/image_preview.dart';
import 'package:camera_app/config/route/routes_name.dart';
import 'package:camera_app/features/camera/presentation/pages/camera_screen.dart';
import 'package:camera_app/features/editor/presentation/editing_screen.dart';
import 'package:camera_app/features/editor/presentation/pages/adjust_page.dart';
import 'package:camera_app/features/editor/presentation/pages/crop_page.dart';
import 'package:camera_app/features/editor/presentation/pages/draw_page.dart';
import 'package:camera_app/features/editor/presentation/pages/filters_page.dart';
import 'package:camera_app/features/editor/presentation/pages/stickers_page.dart';
import 'package:camera_app/features/editor/presentation/pages/text_page.dart';
import 'package:camera_app/features/main/discover/presentation/widgets/image_view.dart';
import 'package:camera_app/features/main/gallery/presentation/widgets/image_view_gallery.dart';
import 'package:camera_app/features/main/main_screen.dart';
import 'package:camera_app/features/auth/presentation/widgets/authentication.dart';
import 'package:camera_app/features/auth/presentation/pages/starting_page.dart';
import 'package:camera_app/features/auth/presentation/pages/sign_in.dart';
import 'package:camera_app/features/auth/presentation/pages/sign_up.dart';
